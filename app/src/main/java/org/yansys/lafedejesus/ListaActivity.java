...
//import org.yansys.android.R.string;
...
public class ListaActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<String>(this,R.layout.lista_item, 
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		case R.id.acercaDe:
			...
			.setMessage("La Fe de Jesus para Android \nVersion 1.0.0.0 (2013)\n\nDesarrollado por: \nYansy R. Gonzalez D. \nyansyr@gmail.com \n\nAutor Original:\nPr. Carlos E. Aeschlimann H. \n\nPor favor, envienos sus comentarios, solicite caracter�sticas, o reporte errores a: \nyansysoporte@gmail.com")
			.setCancelable(true)
	...
	//	String[] valores = getResources().getStringArray(R.array.lista);
